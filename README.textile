*This repository is a mirror of the [component](http://component.io) module [premasagar/cleanslate](http://github.com/premasagar/cleanslate). It has been modified to work with NPM+Browserify. You can install it using the command `npm install npmcomponent/premasagar-cleanslate`. Please do not open issues or send pull requests against this repo. If you have issues with this repo, report it to [npmcomponent](https://github.com/airportyh/npmcomponent).*
h1. Cleanslate
...
h3. iframe-based resetting for distributed content
...
h3. 1) Include the stylesheet

E.g. add this to the host document's @<head>@:

bc. <link rel="stylesheet" href="http://example.com/cleanslate.css" type="text/css" />

With HTML5, you can optionally trim this down:

bc. <link rel=stylesheet href="http://example.com/cleanslate.css">

If you are distributing a Javascript widget, then you can add the stylesheet programatically, e.g. with jQuery:

bc. jQuery('<link rel=stylesheet href="cleanslate.css">')
    .appendTo('head');
...
bc. /* start of stylesheet */
    @import http://example.com/cleanslate.css
/* your other styles follow */


h3. 2) Add the class @cleanslate@ to the HTML container element
...
h3. 4) [optional] Set the default styles
